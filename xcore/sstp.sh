...
wget -O /etc/accel-ppp.conf "https://${Server}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://${Server}/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://${Server}/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://${Server}/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://${Server}/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh
